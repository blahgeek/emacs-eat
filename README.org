...
A bug in emacs-vterm causes non-recoverable truncation of the terminal
buffer content when the window is resized, as in [[issue
#179][https://github.com/akermu/emacs-libvterm/issues/179]. However,
Eat does not have this problem.
